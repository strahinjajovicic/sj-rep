    ...
    <body>
        ...
        <div class="w3-content w3-padding" style="max-width:1564px">
            <div class="w3-container w3-padding-32 w3-display-topmiddle" id="contact">
                <br>
                <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16" align="center">Log In</h3>
                <form action="log.php" method="POST">
                    <input class="w3-input w3-border" type="text" placeholder="Korisniko Ime*" required name="name">
                    <input class="w3-input w3-section w3-border" type="password" placeholder="Lozinka*" required name="password">
                    <br>
